...
#for num in {1..7};do
#    for i in {A,B,D};do
#        bcftools view  -v snps -Ov ~/mapping/08.mergeGVCF/${total}/chr${num}${i}.bcf.gz| bcftools query -H -f '%CHROM\t%POS\t%REF\t%ALT\t[%GT\t%DP\t%GQ\t]\n' > ${total}/chr${num}${i}.snp_matrix &
#    wait_all
#done
#done
#wait
...
#pos=`tail -1 ${total}/${chr}.snp_matrix | awk '{print $2}' | awk '{print int($1/1000000)+1}' `
#line=`tail -1 ${total}/${chr}.snp_matrix | awk '{print $2}' | awk '{print int($1/20000000)+1}' `

#for i in `seq 1 20 | tr '\n' ' '|sed s/,$//g`;do
#(left=$[0+${line}*(${i}-1)]
#right=$[${left}+$line]
#echo $left $right
#head -1 ${total}/${chr}.snp_matrix > ${total}/${chr}.snp_matrix_${i}
#awk 'left*1000000 <= $2 && $2 <= right*1000000 {print $0}' left="$left" right="$right"  ${total}/${chr}.snp_matrix >>  ${total}/${chr}.snp_matrix_${i} ) &
#wait_all
#done
#done
#wait
...
#           if [[ ! -d "tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}" ]]; then
#                mkdir tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}
#           fi 
#           for num in {1..7}; do
#             for i in {A,B,D}; do
#               for item in {deletion,duplication};do
#                 a=`du -h tmp/${total}/${SAMPLE1}_${time_date}/chr${num}${i}.mask_CNV_${item}`
#                 b=`echo $a |awk '{print $1}'`
#                 if [ "${b}" == 0 ];then
#                   echo 'file zero' 
#                   awk '{print $1"\t"$2"\t"$3"\t"SAMPLE2"'"$item"'""_CNV"}' SAMPLE2="$SAMPLE2" tmp/${total}/${SAMPLE2}_${time_date}/chr${num}${i}.mask_CNV_${item}  > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE2}to${SAMPLE1}_own_CNV_${item}
#                 else
#                   echo 'file not zero' 
#                   awk 'NR==FNR{a[$2]=$0;next}NR>FNR{if($2 in a ==0) print $1"\t"$2"\t"$3"\t"SAMPLE2"'"$item"'""_CNV"}' SAMPLE2="$SAMPLE2" tmp/${total}/${SAMPLE1}_${time_date}/chr${num}${i}.mask_CNV_${item} tmp/${total}/${SAMPLE2}_${time_date}/chr${num}${i}.mask_CNV_${item} > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE2}to${SAMPLE1}_own_CNV_${item}
#                 fi
#        #
#                 a=`du -h tmp/${total}/${SAMPLE2}_${time_date}/chr${num}${i}.mask_CNV_${item}`
#                 b=`echo $a |awk '{print $1}'`
#                 echo ${b}
#                 if [ "${b}" == 0 ];then
#                    echo 'file zero'
#                    awk '{print $1"\t"$2"\t"$3"\t"SAMPLE1"'"$item"'""_CNV"}' SAMPLE1="$SAMPLE1" tmp/${total}/${SAMPLE1}_${time_date}/chr${num}${i}.mask_CNV_${item}  > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE1}to${SAMPLE2}_own_CNV_${item}
#                 else
#                    echo 'file not zero'
#                    awk 'NR==FNR{a[$2]=$0;next}NR>FNR{if($2 in a ==0) print $1"\t"$2"\t"$3"\t"SAMPLE1"'"$item"'""_CNV"}' SAMPLE1="$SAMPLE1" tmp/${total}/${SAMPLE2}_${time_date}/chr${num}${i}.mask_CNV_${item} tmp/${total}/${SAMPLE1}_${time_date}/chr${num}${i}.mask_CNV_${item} > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE1}to${SAMPLE2}_own_CNV_${item}
#                 fi
#                 awk 'NR==FNR{a[$2]=$0;next}NR>FNR{if($2 in a ==1) print $1"\t"$2"\t"$3"\t""'"$item"'""_both_CNV"}' tmp/${total}/${SAMPLE1}_${time_date}/chr${num}${i}.mask_CNV_${item} tmp/${total}/${SAMPLE2}_${time_date}/chr${num}${i}.mask_CNV_${item} > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE1}to${SAMPLE2}both_CNV_${item}
#            #3  
#                 cat tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE1}to${SAMPLE2}_own_CNV_${item} tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE2}to${SAMPLE1}_own_CNV_${item} tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}_${SAMPLE1}to${SAMPLE2}both_CNV_${item} > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}.${SAMPLE1}to${SAMPLE2}all_CNV_${item}
#               done
#               cat tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}.${SAMPLE1}to${SAMPLE2}all_CNV_deletion tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}.${SAMPLE1}to${SAMPLE2}all_CNV_duplication | sort -u -nk2,2 > tmp/${total}/${SAMPLE1}_${SAMPLE2}_${time_date}/chr${num}${i}.${SAMPLE1}to${SAMPLE2}all_CNV
#             done
#           done
#         else
#         unset arr[${num}]
