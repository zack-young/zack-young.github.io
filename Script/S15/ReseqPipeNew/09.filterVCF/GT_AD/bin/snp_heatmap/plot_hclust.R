...
# input file
#infile <- "/data/user/yangzz/mapping/09.filterVCF/GT_AD/snp_heatmap/tmp.pg02EgTxyg" 
...
# group file
#groupf <- read.table("/data/user/yangzz/mapping/09.filterVCF/GT_AD/snp_heatmap/tmp.E1dJrNZTa3", col.names = c("Sample", "Group"), sep = "\t", stringsAsFactors = F)
...
pdf(paste(outfile,".pdf",sep=""), height = 10, width = nrow(tmp) * 0.1 + 7)
