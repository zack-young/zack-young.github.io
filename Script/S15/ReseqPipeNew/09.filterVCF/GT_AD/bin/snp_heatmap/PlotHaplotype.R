...
# input file
#infile <- "/data/user/yangzz/mapping/09.filterVCF/GT_AD/snp_heatmap/tmp.WGYo16IMdG" 
...
# group file
#groupf <- read.table("/data/user/yangzz/mapping/09.filterVCF/GT_AD/snp_heatmap/tmp.ZXWtuL22Nw", col.names = c("Sample", "Group"), sep = "\t", stringsAsFactors = F)
