#!/usr/bin/env bash
#
WP=/data2/public/ReseqData/workflowFile
...
for CHR in `echo ${batch} | tr "," " "`; do
    ...
    echo "  -R /data2/rawdata2/genome/Tu/Tu_split.fa \\";
    ...
    #echo "  --variant /data2/user2/xiexm/pro_ject/resequencing/Elymus_repens/06.callsnp/${CHR}.g.vcf.gz \\" >> mergeGVCF_${CHR}.sh
    #
