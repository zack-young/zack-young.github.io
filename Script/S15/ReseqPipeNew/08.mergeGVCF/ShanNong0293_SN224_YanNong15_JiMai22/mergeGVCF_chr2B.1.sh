...
java  \
  ...
  -T GenotypeGVCFs \
  --variant /data/user/yangzz/mapping/Reseq_data/CP12/06.callsnp/chr2B.1.g.vcf.gz \
  --variant /data/user/yangzz/mapping/Reseq_data/SN224/06.callsnp/chr2B.1.g.vcf.gz \
  ...
  --variant /data/user/yangzz/mapping/Reseq_data/TE20/06.callsnp/chr2B.1.g.vcf.gz \
  --variant /data/user/yangzz/mapping/Reseq_data/SNFu63/06.callsnp/chr2B.1.g.vcf.gz \
