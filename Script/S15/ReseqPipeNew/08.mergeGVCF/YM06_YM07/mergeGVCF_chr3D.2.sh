...
java  \
  ...
  -T GenotypeGVCFs \
  --variant /data2/public/ReseqData/workflowFile/YM06/06.callsnp/chr3D.2.g.vcf.gz \
  --variant /data2/public/ReseqData/workflowFile/YM07/06.callsnp/chr3D.2.g.vcf.gz \
