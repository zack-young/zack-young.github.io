...
for SAMPLE1 in ${arr[@]};do
    ...
    for SAMPLE2 in ${arr_2[@]};do
         ...
         Rscript ~/R/graph_diff_sim.R -d "~/mapping/fieldergenomecompare/shi_fu" --sample1 ${SAMPLE1} --sample1_name ${arr_3[${SAMPLE1}]} --sample2 ${SAMPLE2} --sample2_name ${arr_3[${SAMPLE2}]} -s "" 
