...
CHR=$1
(bcftools view --threads 4 -h ${CHR}.g.vcf.gz|sed  's/s30/level85/g';
bcftools view --threads 4 -H ${CHR}.g.vcf.gz)|\
bcftools view --threads 4 -Ob -o ${CHR}.g.ch.vcf.gz

bcftools index ${CHR}.g.ch.vcf.gz
