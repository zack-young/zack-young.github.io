...
line_num=1
SAMPLE1=`echo $sample_line | awk -F '_' '{print $1}'`
SAMPLE2=`echo $sample_line | awk -F '_' '{print $2}'`
#if [ "${SAMPLE1}" != "${SAMPLE2}" ]; then
numerator1=`cat ${DEV_PATH}/${SAMPLE1}_${SAMPLE2}/*.homo_snp_undefined_level|grep 'low'|wc -l`
numerator2=`cat ${DEV_PATH}/${SAMPLE1}_${SAMPLE2}/*.homo_snp_undefined_level|grep 'both_CNV'|wc -l`
denominator=`cat ${DEV_PATH}/${SAMPLE1}_${SAMPLE2}/*.homo_snp_undefined_level | wc -l `
...
echo -e "${arr_3[${SAMPLE1}]}\t${arr_3[${SAMPLE2}]}\t${final_ratio}" >> ${out_file}
echo -e "${arr_3[${SAMPLE1}]}\t${arr_3[${SAMPLE2}]}\t${decimal}" >> ${out_file}_raw
