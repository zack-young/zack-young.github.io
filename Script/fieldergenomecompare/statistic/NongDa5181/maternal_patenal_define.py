...
def Count(infile_1, infile_2, outfile, sample_1, sample_2, son_define, son_norm):
    ...
    if son_define == "on":
        ...
        frame_1[[2]] = frame_1[[2]].astype(int)
        frame_2[[2]] = frame_2[[2]].astype(int)
        frame_1.sort_values(2,inplace=True)
        frame_2.sort_values(2,inplace=True)
        frame_2.index = np.arange(0,len(frame_2))
        frame_1.index = np.arange(0,len(frame_1))
        ...
        df_new.sort_values("start",inplace=True)
