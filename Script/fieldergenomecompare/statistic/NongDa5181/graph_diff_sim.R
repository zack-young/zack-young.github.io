...
options(scipen=200)
files = read.table(paste("/data/user/yangzz/mapping/fieldergenomecompare/lx987_5181_3097/plotfile_",SAMPLE1,"_",SAMPLE2,sep=""), as.is = T, header = F, comment.char = "")

pdf(paste("/data/user/yangzz/mapping/fieldergenomecompare/lx987_5181_3097/pdf/",arguments$suffix,".pdf",sep=""), height = figure.height, width = figure.width)
...
color_pad <- c(fa, ma, both, unknown)
num = 22
...
rect(xleft = 900, xright = 930, ybottom = 26, ytop = 28,
     col = color_pad[1], border = color_pad[1]);text(x=c(940), y=c(27),c(SAMPLE1_name),cex = 1,pos = 4)
rect(xleft = 900, xright = 930, ybottom = 28, ytop = 30,
     col = color_pad[2], border = color_pad[2]);text(x=c(940), y=c(29),c(SAMPLE2_name),cex = 1,pos = 4)
rect(xleft = 900, xright = 930, ybottom = 30, ytop = 32,
     col = color_pad[3], border = color_pad[3]);text(x=c(940), y=c(31),c("Both"),cex = 1,pos = 4)
rect(xleft = 900, xright = 930, ybottom = 32, ytop = 34,
     col = color_pad[4], border = color_pad[4]);text(x=c(940), y=c(33),c("Unknown"),cex = 1,pos = 4)
for(j in 1:nrow(files)){
  if(!is.na(files[j,1])){
    ...
    chro1 <- factor(chro, 
                    ...
                    levels = c(SAMPLE1,SAMPLE2,"both","unknown"),
