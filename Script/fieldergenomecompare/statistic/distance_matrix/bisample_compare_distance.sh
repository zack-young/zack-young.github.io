...
numerator1=`cat ${DEV_PATH}/${SAMPLE1}_${SAMPLE2}/*.homo_undefined_snp_level.sorted.v4|grep 'low'|wc -l`
numerator2=`cat ${DEV_PATH}/${SAMPLE1}_${SAMPLE2}/*.homo_undefined_snp_level.sorted.v4|grep 'both_CNV'|wc -l`
denominator=`cat ${DEV_PATH}/${SAMPLE1}_${SAMPLE2}/*.homo_undefined_snp_level.sorted.v4 | wc -l `
