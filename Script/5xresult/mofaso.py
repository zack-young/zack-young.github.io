...
#            print("\t".join([b, "%s" % start, "%s" % end, "%s" % count1, "%s" % count2, "%s" % count3]))
            if count1 >= highun:
                print("\t".join([b, "%s" % start, "%s" % end, "5181", "high"]))
            elif lowun <= count1 < highun:
                print("\t".join([b, "%s" % start, "%s" % end, "5181", "mid"]))
            else:
                print("\t".join([b, "%s" % start, "%s" % end, "5181", "low"]))
            #
            if count2 >= highun:
                print("\t".join([b, "%s" % start, "%s" % end, "lx987", "high"]))
            elif lowun <= count2 < highun:
                print("\t".join([b, "%s" % start, "%s" % end, "lx987", "mid"]))
            else:
                print("\t".join([b, "%s" % start, "%s" % end, "lx987", "low"]))
            #
            if count3 >= highun:
                print("\t".join([b, "%s" % start, "%s" % end, "3097", "high"]))
            elif lowun <= count3 < highun:
                print("\t".join([b, "%s" % start, "%s" % end, "3097", "mid"]))
            else:
                print("\t".join([b, "%s" % start, "%s" % end, "3097", "low"]))
