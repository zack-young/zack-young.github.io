...
#	    print("\t".join([b, "%s" % start, "%s" % end, "%s" % hete, "%s" % father, "%s" % mother]))
            if son >= highun and count2>= highun and count3>= highun:
            	print("\t".join([b, "%s" % start, "%s" % end, "%s" % hete, "%s" % father, "%s" % mother, "high"]))
            if lowun <= son < highun and lowun <= count2 < highun and lowun <= count3 < highun:
                print("\t".join([b, "%s" % start, "%s" % end, "%s" % hete, "%s" % father, "%s" % mother, "mid"]))
            if son < lowun and count2 < lowun and count3 < lowun:
                print("\t".join([b, "%s" % start, "%s" % end, "%s" % hete, "%s" % father, "%s" % mother, "low"]))
            #
