...
#heat_map
color_pad <- c("#000000", "#e5e5e5", "#FFFFFF", "#00FFFF", "#1E90FF", "#66CD00", "#FFFF00", "#FFC1C1", "#CD5C5C", "#8b658b", "#EE00EE", "#FF0000", "#DAA520", "#FF8C00", "#FFA07A", "#FF4500", "#BC8F8F", "#D2691E", "#FFB6C1", "#DC143C", "#DB7093", "#C71585", "#8B008B", "#6A5ACD", "#191970", "#2F4F4F", "#006400", "#556B2F", "#800000", "#4B0082", "#4F4F4F", "#68228B", "#CDB38B", "#0000CD", "#708090")
...
for(i in 1:ncol(data)){
	...
	for (j in 1:length(data[,i])){
		if((-as.numeric(data[j,i])+3) > length(color_pad)){
			color <- c(color, "#000000")
		}else{
			color <- c(color, color_pad[(-as.numeric(data[j,i])+3)])
		}
	}
