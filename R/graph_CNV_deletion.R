...
options(scipen=200)
files = read.table(paste("/data/user/yangzz/mapping/S15/ReseqPipeNew/09.filterVCF/GT_AD/plotfile/plotfile_",SAMPLE1,"_",SAMPLE2,"_deletion",sep=""), as.is = T, header = F, comment.char = "")

pdf(paste("/data/user/yangzz/mapping/S15/ReseqPipeNew/09.filterVCF/GT_AD/pdf/",SAMPLE1_name,"_",SAMPLE2_name,arguments$suffix,"_deletionCNV.pdf",sep=""), height = figure.height, width = figure.width)
...
rect(xleft = 900, xright = 930, ybottom = 28, ytop = 30,
     col = color_pad[4], border = color_pad[4]);text(x=c(940), y=c(29), paste(SAMPLE1,"deletion_CNV",sep=""),cex = 1,pos = 4)
...
rect(xleft = 900, xright = 930, ybottom = 32, ytop = 34,
     col = color_pad[5], border = color_pad[5]);text(x=c(940), y=c(33),paste(SAMPLE2,"deletion_CNV",sep=""),cex = 1,pos = 4)
