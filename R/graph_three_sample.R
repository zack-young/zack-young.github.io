library(gplots)
files = read.table("/data/user/yangzz/mapping/fieldergenomecompare/202009_11_yaoyy/plotfile_CP07_CP09_CP11_884", as.is = T, header = F, comment.char = "")
...
text(x=rep(860,11), y=seq(18,48,3),#x=seq(-190,-50,20), y=rep(30.5,8),
     c("Undefiend","884187","954072","ji200040919","Both Deletion","Both Duplication","AlphaGliadin","GammaGliadin","OmegaGliadin","HMW","LMW"),cex = 0.8,pos=4)#,srt=90)
