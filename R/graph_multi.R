...
text(x=rep(920,8), y=seq(18,39,3),#x=seq(-190,-50,20), y=rep(30.5,8),
     c("NongDa3338","JingDong6","Unknown","Shared","LunXuan987","NongDa3097","Unknown","Shared"),cex = 0.8,pos=4)#,srt=90)

rect(xleft = rep(920,8), xright = rep(930,9),
     ybottom = seq(17.5,38.5,3),
     ytop = seq(18.5,39.5,3),
     col = color_pad, border = color_pad)
